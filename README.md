...
本館入口の「新館のご案内」、またはエレベーターの「新」ボタンよりお越しいただけます。
お急ぎの方は新館直通口をどうぞ → [`/#yokocho`](https://airuky.github.io/Tenchi-Department-Store/#yokocho)
...
| 本館入口(開店の瞬間) | 新館「夜の横丁」 |
|---|---|
| ![本館入口 — 金の扉が開き、星空の玄関へ](docs/screenshot-hero.png) | ![夜の横丁 — 提灯の下に5店舗](docs/screenshot-yokocho.png) |

| B1F 深海水族館 | B5F 文明の年代記 |
|---|---|
| ![深海水族館 — 光の届かない売り場](docs/screenshot-aquarium.png) | ![文明の年代記 — 羊皮紙の大陸](docs/screenshot-chronicle.png) |

<p align="center">
  <img src="docs/receipt-sample.png" width="280" alt="レシート見本">
  <br><sub>お買い上げ明細の見本(担当: リュウグウノツカイ・長物部門)。約5000年で化石になります。</sub>
</p>
